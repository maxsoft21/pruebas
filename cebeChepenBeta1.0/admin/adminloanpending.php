    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema cebe chepén mini biblioteca <small>- préstamos y reservaciones</small></h1>
            </div>
        </div>
                ...
                if(mysqli_num_rows($checkLoansPending)>=1){
                    ...
                    while($data=mysqli_fetch_array($checkLoansPending)){
                        ...
                        if(mysqli_num_rows($checkLoanU1)>=1){
                            ...
                            $selectTeacherData=ejecutarSQL::consultar("SELECT * FROM docente d inner join datospersonales dp on dp.dni=d.dni WHERE d.dni='".$dataU1['dni']."'");
                            $dataT=mysqli_fetch_array($selectTeacherData);
                            $nameUser=$dataT['nombres']." ".$dataT['apellidos'];
                            $typeUser='Docente';
                        }
