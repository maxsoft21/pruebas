...
<html lang="es">
    ...
    <body>
        ...
        $TeacherN = consultasSQL::CleanStringText($_GET['BuscarN']);
        ?>
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="conteiner-fluid">
                <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                    ...
                    <li role="presentation"  class="active"><a href="adminliststudent.php">Docentes</a></li>
            ...
            <div class="container-fluid">
                 <div class="pull-right" style="width: 30% !important;">
                    <div class="group-material">
                        <input type="search" id="busca" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Buscar docente" name="BuscarN" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe los nombres, sin los apellidos">
                        <button class="btn btn-busca" data-url="../process/ListDataDocente_User.php" style="margin: 0; height: 43px; background-color: transparent !important;">
