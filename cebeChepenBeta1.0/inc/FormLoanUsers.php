    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
            ...
            <form action="process/AddLoanUsers.php" method="post" class="form_SRCB" data-type-form="saveReservation" autocomplete="off">
                <?php
                    $checkAd=ejecutarSQL::consultar("SELECT * FROM usuario WHERE idRol=2");
                    ...
                    echo '<input type="hidden"  name="userDni" value="'.$rowAd['dni'].'">';
                    echo '<input type="hidden"  name="adminCode" value="'.$rowAd['idUsuario'].'">';
