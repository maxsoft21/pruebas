...
if (isset($_POST['from'])) {
    ...
    if ($_POST['from'] != "" AND $_POST['to'] != "") {
        ...
        $query = "INSERT INTO eventos VALUES(null,'$titulo','$body','','$clase','$inicio','$final','$inicio_normal','$final_normal','$idUsuario')";
...
<body style="background: white;">
    ...
    <div class="container">
        ...
        <div class="row col-md-11">
            <div id="calendar"></div> <!-- Aqui se mostrará nuestro calendario -->
            <br><br>
        </div>
    ...
    <div class="modal fade" id="add_evento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="zmdi zmdi-close"></i> Cancelar</button>
                    <button type="submit" class="btn btn-success"><i class="zmdi zmdi-check"></i> Agregar</button>
                    </form>
                </div>
            </div>
        </div>
